/**
 * DeepSeek Worker Prompt - Data Fetcher
 *
 * Worker 模式的特点：
 * - 不聊天：只执行任务，不废话
 * - 结构化输出：返回格式化数据
...
/**
 * DeepSeek Worker 系统提示词
 */
export const DEEPSEEK_WORKER_SYSTEM_PROMPT = `你是一个数据获取助手。你的职责是执行工具调用，返回结构化数据。
...
/**
 * DeepSeek Worker 模型调用参数
 */
export const DEEPSEEK_WORKER_CONFIG = {
 ...
 * DeepSeek 意图分类器配置
 */
export const DEEPSEEK_CLASSIFIER_CONFIG = {
  model: "deepseek-ai/DeepSeek-V3.2",
