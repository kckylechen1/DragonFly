...
import { ChatHistoryList } from "@/refactor_v2/components/ai/ChatHistoryList";
import { TaskExecutionPanel } from "@/refactor_v2/components/ai/TaskExecutionPanel";
import { PresetPrompts } from "@/refactor_v2/components/ai/PresetPrompts";
...
export const AIChatPanel: React.FC = () => {
  ...
  const { data: activeTodoRun } = useActiveTodoRun(sessionId || undefined, isLoading);
  ...
  return (
    <div className="flex flex-col h-full bg-[var(--panel-bg)]">
      ...
      {!hasMessages && !isLoading && (
        <PresetPrompts onSend={handleSend} />
      )}
