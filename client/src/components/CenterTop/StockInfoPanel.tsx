...
export const StockInfoPanel: React.FC<StockInfoPanelProps> = memo(
  function StockInfoPanel({ quote, capitalFlow }) {
    return (
      <div className="flex flex-col gap-2 rounded-lg border border-[var(--panel-border)] bg-[var(--bg-secondary)] p-3 text-xs">
        ...
        <div className="border-t border-[var(--panel-border)] pt-2">
          <div className="flex flex-wrap gap-x-4 gap-y-1">
            ...
            <DataCellInline label="市盈率" value={formatNumber(quote.pe)} />
            <DataCellInline
              label="总市值"
