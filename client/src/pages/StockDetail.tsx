        ...
        {isLoading ? (
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6 bg-card">
              <h2 className="text-lg font-semibold text-foreground mb-4">实时行情</h2>
            ...
            {/* K线图卡片 */}
            <Card className="p-6 bg-card">
              <h2 className="text-lg font-semibold text-foreground mb-4">K线图</h2>
              <KLineChart data={klineData || []} />
            </Card>

            {/* 技术指标卡片 */}
            <Card className="p-6 bg-card">
              <h2 className="text-lg font-semibold text-foreground mb-4">技术指标</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="p-4 rounded-lg bg-accent">
                  ...
                  <p className="text-lg font-semibold text-foreground">待计算</p>
                  <p className="text-xs text-muted-foreground mt-1">MA5/MA20/MA60</p>
                </div>
              </div>
            </Card>
            ...
            {/* 资金流向卡片 */}
            <Card className="p-6 bg-card">
              <h2 className="text-lg font-semibold text-foreground mb-4">资金流向</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 rounded-lg bg-accent">
            ...
            {/* AI分析卡片 */}
            <Card className="p-6 bg-card">
              <h2 className="text-lg font-semibold text-foreground mb-4">AI综合分析</h2>
              {aiLoading ? (
                ...
                <div className="space-y-4">
                  <div className="p-4 rounded-lg bg-accent">
                    ...
                    <div className="space-y-1">
                      {aiAnalysis.technicalSignals?.map((signal: string, idx: number) => (
                  ...
                  <div className="p-4 rounded-lg bg-accent">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm text-muted-foreground">评分: {aiAnalysis.sentimentScore}/100</span>
                    </div>
                  ...
                  <div className="p-4 rounded-lg bg-accent">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm text-muted-foreground">评分: {aiAnalysis.capitalScore}/100</span>
                    </div>
                    <p className="text-sm text-muted-foreground">功能开发中...</p>
                  </div>
                ...
                <div className="text-sm text-muted-foreground">无法获取分析数据</div>
              )}
            </Card>
          </div>
        )}
