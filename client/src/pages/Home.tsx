        ...
        <ResizablePanel defaultSize={75} minSize={50}>
          <div className="h-full flex items-start justify-center overflow-hidden">
            <div className="w-full max-w-[1400px] h-full flex flex-col">
              ...
              {/* 使用垂直 ResizablePanelGroup 让 K线图和新闻区可拖拽 */}
              <ResizablePanelGroup direction="vertical" className="flex-1 min-h-0">
                ...
                <ResizablePanel defaultSize={70} minSize={40}>
                  <div className="h-full flex">
                    ...
                    {/* 市场情绪 - 仅在宽屏(2xl+)显示 */}
                    <div
                      className="hidden 2xl:flex flex-[15] min-w-[160px] border-l border-border flex-col bg-card/30"
                    >
                      <Accordion
                        type="multiple"
                        defaultValue={[]}
                ...
                {/* 下半部分：新闻/趋势/情绪分析 - 可拖拽调整大小 */}
                <ResizablePanel defaultSize={30} minSize={10} collapsible collapsedSize={0}>
                  <div className="h-full border-t border-border flex flex-col bg-card/20">
                    {/* 标签导航 */}
